...
export const Spawn: FC<SpawnProps> = ({ avatar, onSpawnFinish }) => {
    ...
    return (
        <>
            {usesMountEffect && <SpawnEffect onMountEffect={animationProps.onMountEffect} onSpawnEffectFinish={onSpawnEffectFinish}/>}
            {usesMountAnimation && <SpawnAnimation onMountAnimation={animationProps.onMountAnimation} avatar={avatar} onSpawnAnimationFinish={onSpawnAnimationFinish}/>}
        </>
    )
}