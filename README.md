...
```sh
npm install @react-three/drei@9.79.3 @react-three/fiber@8.13.15 @react-three/postprocessing@2.15.0 three@0.154 three-stdlib@2.23.13 suspend-react@0.1.3 postprocessing@6.32.2
```
